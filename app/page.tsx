      ...
      <section className="py-24 px-6 bg-gradient-to-br from-gray-900 to-black text-white">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 mt-3 text-sm tracking-wide">{t.testimonials.subtitle}</p>
          </div>
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10 space-y-8">
          ...
          <div className="mt-12 flex flex-wrap justify-center items-center gap-6 md:gap-8 text-white/90">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs md:text-sm font-semibold">{t.cta.trust.commitment}</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span className="text-xs md:text-sm font-semibold">{t.cta.trust.security}</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clipRule="evenodd" />
              </svg>
              <span className="text-xs md:text-sm font-semibold">{t.cta.trust.speed}</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto space-y-6">
          <div className="flex justify-center">
            <a 
              ...
              className="text-2xl hover:text-[#00C4EF] transition-colors"
              aria-label="LinkedIn"
            >
