  ...
  return (
    <>
      ...
      >
        ...
        <motion.div
          style={{ y }}
          className="absolute inset-x-0 bottom-0 h-full z-20 pointer-events-none md:pointer-events-auto"
        >
          <img
            src="/footer-robot.png"
            alt="AI Robot"
            className="w-full h-full object-contain object-bottom origin-bottom scale-100 sm:scale-110 md:scale-[2.0] lg:scale-105 md:hover:scale-[2.2] lg:hover:scale-115 md:active:scale-[2.3] lg:active:scale-120 hover:rotate-1 active:rotate-2 transition-all duration-300 cursor-pointer animate-float"
          />
        </motion.div>
      </section>
    </>
